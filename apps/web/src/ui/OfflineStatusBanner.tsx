...
export function OfflineStatusBanner() {
  ...
  return (
    ...
    >
      <strong>Нет сети.</strong> Показаны сохранённые на устройстве данные (рейсы, отчёты, справочники). Продажи без
      связи попадают в раздел «Офлайн» и отправятся сами, когда интернет появится.
    </div>
  );
}
