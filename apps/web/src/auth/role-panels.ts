...
export const NAV_PANEL_LABELS: Record<PanelId, string> = {
  ...
  /** Запись недостачи по рейсу (`OperationsPanel`); кг со склада в рейс — привязка ПН; продажа — у продавца. */
  operations: "Недостача по рейсу",
  sellerDispatch: "Назначить продавца",
  assignSeller: "Продавец и продажи",
