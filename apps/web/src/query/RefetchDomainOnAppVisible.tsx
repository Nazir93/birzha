...
/**
 * В PWA/браузере данные (рейсы, отчёт, партии) могли измениться на другом устройстве.
 * При возврате во вкладку или в установленное приложение помечаем кэш устаревшим — активные экраны перезапросят API.
 *
