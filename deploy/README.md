...
**Необратимо** удаляет накладные, рейсы, партии, продажи, погрузочные накладные, контрагентов и т.п. **Сохраняются** учётные записи (`users`), склады, калибры и справочник направлений отгрузки.
